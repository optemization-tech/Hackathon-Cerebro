...
- 2026-05-17 / @optemism / pulse-log/05.17/012-optemism-run-briefs-cli.md — Run-briefs CLI: orchestrates channels→messages→briefs→STM write pipeline with A/B experiment support (PR #101).
